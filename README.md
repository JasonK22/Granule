# Granule
A personal budget tracker that lives entirely on your device — no accounts,
no servers, no syncing. Log what comes in and goes out, set monthly limits
per category, and let the dashboard do the arithmetic.
...
- **Multi-currency** — Switch the display currency in settings, choose from USD - US Dollar
EUR - Euro
GBP - British Pound
JPY - Japanese Yen
CAD - Canadian Dollar
